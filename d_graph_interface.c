 ...
 * Lấy tên đỉnh khi biết id của nó.
 - `graph` đồ thị đầu vào
 - `id` id của đỉnh 
 - \return con trỏ đến tên của đỉnh cần tìm
 * \example examples/
 */
...
// Trả về bậc của đỉnh với mode tương ứng, dãy output chứa danh sách các đỉnh kề tương ứng
